...
export const DeleteIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" aria-hidden="true" fill="red">
...
export const NotInterstedIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const FollowIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const UnfollowIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const AddtoList = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const BlockIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const EngagementsIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const EmbedIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const ReportIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const RequestCommunityIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const CopyLinkIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
...
export const SendViaMsgICon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    aria-hidden="true"
